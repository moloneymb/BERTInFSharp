...
type Vocab = System.Collections.Generic.IDictionary<string,int>
type InvVocab = System.Collections.Generic.IDictionary<int,string>

/// Loads a vocabulary file into a dictionary.
let load_vocab(vocab_file : string) = 
    System.IO.File.ReadAllLines(vocab_file) |> Array.mapi (fun i x -> (x.Trim(),i)) |> dict
...
type WordpieceTokenizer(vocab : Vocab,
    ...
    member this.Unk_token = unk_token
    member this.Max_input_chars_per_word = max_input_chars_per_word
